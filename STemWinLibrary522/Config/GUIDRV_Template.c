...
static void _SetPixelIndex(GUI_DEVICE * pDevice, int x, int y, int PixelIndex) {
    ...
    GUI_USE_PARA(PixelIndex);
    {
      ...
      // TBD by customer...
      //
			LCD_SetPoint(xPhys, yPhys, PixelIndex);
    }
...
static unsigned int _GetPixelIndex(GUI_DEVICE * pDevice, int x, int y) {
  unsigned int PixelIndex;
    ...
    GUI_USE_PARA(y);
    {
      ...
      // TBD by customer...
      //
			PixelIndex = LCD_GetPoint(xPhys, yPhys);
    }
    #if (LCD_MIRROR_X == 0) && (LCD_MIRROR_Y == 0) && (LCD_SWAP_XY == 0)
      #undef xPhys
      #undef yPhys
...
//   }
    ...
    *(__IO u16 *) (Bank1_LCD_D) = (x0>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = x0 & 0xff;
    *(__IO u16 *) (Bank1_LCD_D) = (x1>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = x1 & 0xff;
    
    *(__IO u16 *) (Bank1_LCD_C) = 0x2b;
    *(__IO u16 *) (Bank1_LCD_D) = (y0>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = y0 & 0xff;
    *(__IO u16 *) (Bank1_LCD_D) = (y1>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = y1 & 0xff;

    *(__IO u16 *) (Bank1_LCD_C) = 0x2c;
    while ( cnt-- )
    {
        *(__IO u16 *) (Bank1_LCD_D) = ColorIndex;
    }
...
// #if LCD_SWAP_XY | LCD_MIRROR_X| LCD_MIRROR_Y
   ...
   lphys = (x1 - x0);
    ...
    {
        *(__IO u16 *) (Bank1_LCD_C) = 0x2a;
        *(__IO u16 *) (Bank1_LCD_D) = (xPhys>>8)&0xff;
        *(__IO u16 *) (Bank1_LCD_D) = xPhys & 0xff;
        *(__IO u16 *) (Bank1_LCD_D) = (480>>8)&0xff;
        *(__IO u16 *) (Bank1_LCD_D) = 480 & 0xff;
    
        *(__IO u16 *) (Bank1_LCD_C) = 0x2b;
        *(__IO u16 *) (Bank1_LCD_D) = (yPhys>>8)&0xff;
        *(__IO u16 *) (Bank1_LCD_D) = yPhys & 0xff;
        *(__IO u16 *) (Bank1_LCD_D) = (yPhys>>8)&0xff;
        *(__IO u16 *) (Bank1_LCD_D) = yPhys & 0xff;

        *(__IO u16 *) (Bank1_LCD_C) = 0x2c;
        for (; xPhys <= lphys; xPhys++)
        {
            *(__IO u16 *) (Bank1_LCD_D) = ColorIndex ;
        }  
    }
...
//   }
    ...
    *(__IO u16 *) (Bank1_LCD_C) = 0x2b;
    *(__IO u16 *) (Bank1_LCD_D) = (y>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = y & 0xff;
    *(__IO u16 *) (Bank1_LCD_D) = (272>>8)&0xff;
    *(__IO u16 *) (Bank1_LCD_D) = 272 & 0xff;
