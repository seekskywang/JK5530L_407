...
void i2c_CfgGpio(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);//开启GPIOF时钟

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3|GPIO_Pin_6;//定义端口PF
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//设置为输出模式
	GPIO_InitStructure.GPIO_Speed =GPIO_Speed_50MHz;//设置输出频率
	GPIO_Init(GPIOD, &GPIO_InitStructure);//将设置输入函数
